...
const int w_size = sizeof(long) * 8;


inline int words (int i){
    return i / w_size;
}
...
bit_set::bit_set (int f, int l, bool no_clear)
...
void
bit_set::expand (int f, int l, bool no_clear)
{
    int sz;
...
void
bit_set::transfer (bit_set *src, bool del)
{
    if (bits)
	delete[] bits;
    *this = *src;
